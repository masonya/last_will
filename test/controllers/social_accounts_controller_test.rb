...
class SocialAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social_account" do
    assert_difference('SocialAccount.count') do
      post social_accounts_url, params: { social_account: { body: @social_account.body, title: @social_account.title } }
    end
  ...
  test "should update social_account" do
    patch social_account_url(@social_account), params: { social_account: { body: @social_account.body, title: @social_account.title } }
